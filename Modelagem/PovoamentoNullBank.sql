...
('depósito', curdate(), '5000.00', '11'),
('transferência', curdate(), '1500.00', '11'),
('saque', curdate(), '1000.00', '11'),
('depósito', curdate(), '10000.00', '12'),
('estorno', curdate(), '1000.00', '12'),
('transferência', curdate(), '2000.00', '12'),
('pagamento', curdate(), '1000.00', '12'),
('depósito', curdate(), '7000.00', '17'),
('depósito', curdate(), '1000.00', '17'),
('saque', curdate(), '3500.00', '17'),
('depósito', curdate(), '20000.00', '15'),
('estorno', curdate(), '1555.00', '15'),
('transferência', curdate(), '4000.00', '15'),
('pagamento', curdate(), '1000.00', '15'),
('depósito', curdate(), '10000.00', '14'),
('estorno', curdate(), '1000.00', '14'),
('transferência', curdate(), '3000.00', '14'),
('pagamento', curdate(), '1500.00', '14');
